...
magic_items_c = {
    ...
    "98": "Necklace of fireballs (one bead)",
...
magic_items_g = {
    "01-11": "Weapon, +2",
    "12-14": "Figurine of wondrous power (roll d8: bronze griffon, ebony fly, golden lions, ivory goats, marble elephant, onyx dog, silver raven, serpentine owl)",
...
def magic_items(table):
    match table:
        case "a":
            return magic_items_a
        case "b":
            return magic_items_b
        case "c":
            return magic_items_c
        case "d":
            return magic_items_d
        case "e":
            return magic_items_e
        case "f":
            return magic_items_f
        case "g":
            return magic_items_g
        case _:
            print("Magic items table not found")